        ...
        options: {
            ...
            onClick: function(event, chartElement) {
                ...
                if (chartElement.length > 0) {
                    var divisionClicked = chartElement[0]._model.label;

                    // Mettre à jour les données de l'histogramme en fonction de la division cliquée
                    var updatedEtatData = getEtatDataForDivision(divisionClicked);

                   // Mettre à jour l'histogramme
                    tasksHistogram.data.datasets[0].data = updatedEtatData;
                    tasksHistogram.update();
                }
            }
        }
    });
