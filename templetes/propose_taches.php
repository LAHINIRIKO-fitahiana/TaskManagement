...
if (isset($_POST['create'])) {
    ...
    $status = 'proposee'; // Le statut est fixé à 'validee' pour toutes les nouvelles tâches
...
$query_user = "SELECT IM, username, division
                FROM users 
                WHERE status = 'active'";
...
<div class="container mt-4">
    <div class="form-container p-4">
        <h1 class="text-center mb-4">Proposer un activité</h1>
