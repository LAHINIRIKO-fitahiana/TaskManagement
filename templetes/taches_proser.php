...
AND tasks.status = 'proposee'"; // Ajustez la requête selon votre base de données
...
<div class="container">
    ...
    <i class="fas fa-edit"></i>
            ...
            <?php else: ?>
            <tr>
                <td colspan="7" class="text-center">Aucun activité proposée disponible.</td>
            </tr>
            <?php endif; ?>
        </tbody>
        <tfoot>
                ...
                <td colspan="9">
                    <div class="text-right mt-4">
                        <a href="propose_taches.php" class="btn btn-primary ml-4">
                            <i class="fas fa-plus"></i> Proposer un activités
                        </a>
                    </div>
                </td>
            </tr>
